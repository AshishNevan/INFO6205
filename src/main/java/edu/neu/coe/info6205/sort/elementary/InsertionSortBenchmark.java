...
public class InsertionSortBenchmark {
    public static void main(String[] args) throws Exception {
        ...
        for(int n: arrayOfN) {
            ...
            Benchmark_Timer<Integer[]> InsertionSortRandomBM = new Benchmark_Timer<>("Random Order of size "+n, InsertionSortBenchmark::apply, InsertionSort);
            double meanRunTime = InsertionSortRandomBM.runFromSupplier(createRandomSupplier.apply(n),nRuns);

            Benchmark_Timer<Integer[]> InsertionSortSortedBM = new Benchmark_Timer<>("Sorted Order of size "+n, InsertionSortBenchmark::apply, InsertionSort);
            double meanRunTime2 = InsertionSortSortedBM.runFromSupplier(createSortedSupplier.apply(n),nRuns);

            Benchmark_Timer<Integer[]> InsertionSortReverseSortedBM = new Benchmark_Timer<>("Reverse Sorted Order of size "+n, InsertionSortBenchmark::apply, InsertionSort);
            double meanRunTime3 = InsertionSortReverseSortedBM.runFromSupplier(createReverseSortedSupplier.apply(n),nRuns);

            Benchmark_Timer<Integer[]> InsertionSortPartiallySortedBM = new Benchmark_Timer<>("Partially Sorted Order of size "+n, InsertionSortBenchmark::apply, InsertionSort);
